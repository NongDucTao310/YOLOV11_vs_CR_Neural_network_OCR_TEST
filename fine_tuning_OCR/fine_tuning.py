...
class OCRDataset(Dataset):
    ...
    def __getitem__(self, idx):
        ...
        image = Image.open("./dataset/images/"+f"{image_path}").convert("L")  # Convert to grayscale
        if self.transform:
...
if __name__ == "__main__":
    labels_file = r"./dataset/labels.json"  # Input labels file
    output_model_path = r"./model2.pth"  # Output model path
    pretrained_model_path = "./model1.pth"  # Use pre-trained model if available
